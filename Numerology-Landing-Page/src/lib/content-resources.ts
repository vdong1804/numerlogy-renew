...
export const CONTENT_RESOURCES: ContentResource[] = [
  ...
  { slug: 'execution-number', label: 'Số Thực Hiện' },
  { slug: 'souls-number', label: 'Số Linh Hồn' },
  { slug: 'development-number', label: 'Số Phát Triển' },
  { slug: 'peak-life', label: 'Đỉnh Cao Cuộc Đời' },
  ...
  { slug: 'mature-number', label: 'Số Trưởng Thành' },
  { slug: 'introspective-number', label: 'Số Nội Tâm' },
  { slug: 'karmic-number', label: 'Số Nghiệp' },
  { slug: 'deficit-number', label: 'Số Thiếu Hụt' },
  ...
  { slug: 'balance-number', label: 'Số Cân Bằng' },
  { slug: 'miss-number', label: 'Số Bỏ Lỡ' },
  { slug: 'personal-year-number', label: 'Số Năm Cá Nhân' },
  { slug: 'phone-master-data', label: 'Dữ Liệu Tổng Hợp SĐT', isPhoneMaster: true },
]
